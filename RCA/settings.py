...
SECRET_KEY = 'django-insecure-fcl+fw%$*5t-+=!(^3f4w!#gt&2*ji!h4v46br7a575ziyvd#i'
...
PG_DB_HOST = config('DB_HOST')
PG_DB_PORT = config('DB_PORT')
PG_DB_NAME = config('DB_NAME')
PG_DB_USER = config('DB_USER')
PG_DB_PASS = config('DB_PASS')
...
REST_KNOX = { 
    ...
    'USER_SERIALIZER': 'userapp.serializer.UserSerializer'
}
